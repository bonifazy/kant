...
сервисов c CRM, наподобие 'InSales'.
...
синхронизируя всю базу, вызов с присвоением бренда page = Main('Adidas') работает с таблицами только этого бренда.
  ...
  * В ближайшее время добавится сериализатор выгрузки карточек товара для маркетплейсов, 'InSales' и 'МойСклад' (xml).
Рабочий используемый метод: Main.export() На данный момент идет тестирование всех сериализаторов и основных рабочих
шаблонов выгрузки популярных сервисов.
